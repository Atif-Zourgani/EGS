(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/discipline"],{

/***/ "./assets/js/discipline.js":
/*!*********************************!*\
  !*** ./assets/js/discipline.js ***!
  \*********************************/
...
$(document).ready(function () {
  ...
  $('.discipline-levels .level:first-of-type').addClass('active');
  showSkills();

  function showSkills() {
    var level = $('.level.active').attr('data-value'); // active level

    $('.block-skills').each(function () {
      // for each skill
      if ($(this).attr('data-value') === level) {
        // if skill's level = active level
