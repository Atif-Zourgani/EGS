 ...
 */
final class Version20190328093530 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE skill ADD level_id INT DEFAULT NULL, DROP level');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE skill ADD level VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP level_id');
    }
}
