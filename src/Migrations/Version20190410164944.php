 ...
 */
final class Version20190410164944 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE student_evaluation (id INT AUTO_INCREMENT NOT NULL, student_id INT NOT NULL, UNIQUE INDEX UNIQ_FEFC4894CB944F1A (student_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE tstudent_skill (id INT AUTO_INCREMENT NOT NULL, teacher_id INT DEFAULT NULL, team_id INT DEFAULT NULL, student_evaluation_id INT DEFAULT NULL, skill_id INT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_FB069EF141807E1D (teacher_id), INDEX IDX_FB069EF110F0AED8 (student_evaluation_id), UNIQUE INDEX UNIQ_FB069EF15585C142 (skill_id), INDEX IDX_FB069EF1296CD8AE (team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
